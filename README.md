...
* In order to run the app in the production mode please run `npm run build`. This will create a production build of the app in the `build/` folder in the project directory. For more information regarding running production built please read [React Documentation](https://reactjs.org/docs/optimizing-performance.html)
